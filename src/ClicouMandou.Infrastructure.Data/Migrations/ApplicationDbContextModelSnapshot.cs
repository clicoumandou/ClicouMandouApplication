...
namespace ClicouMandou.Infrastructure.Data.Migrations
{
    [DbContext(typeof(ClicouMandouDbContext))]
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ClicouMandou.Infrastructure.Data.Domain.ProjetoArg.Projeto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("ProjetoCode");

                    b.HasKey("Id");
                });

            modelBuilder.Entity("ClicouMandou.Infrastructure.Data.Domain.UserArg.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ClicouMandou.Infrastructure.Data.Domain.UserArg.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("ClicouMandou.Infrastructure.Data.Domain.UserArg.ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ClicouMandou.Infrastructure.Data.Domain.UserArg.ApplicationUser")
                        .WithMany()
